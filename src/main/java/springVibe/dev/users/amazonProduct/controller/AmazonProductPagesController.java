...
public class AmazonProductPagesController {
    ...
    public String list(
        ...
        try {
            ListResult r = amazonProductService.list(q, categoryId, sortKey, safePage, safeSize);
        ...
        if (model.getAttribute("selectedCategoryId") == null) model.addAttribute("selectedCategoryId", categoryId);
