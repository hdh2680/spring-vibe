...
## 개발 후...
유튜브 댓글 데이터를 수집하여 키워드, 네트워크, 감정분석을 수행하고, 사전 기반 감정 분석의 한계를 보완하기 위해
불확실한 데이터에 한해 LLM 재검증을 적용함으로써 분석 정확도를 향상시켰습니다. 또한 선택적 LLM 사용 전략을 통해
비용 효율성을 확보하고, 시각화된 결과를 통해 사용자에게 직관적인 여론 인사이트를 제공할 수 있도록 구현했습니다.
